...
WebUI.click( findTestObject('Object Repository/Page_Dasbor  admin/a_2                        Manajemen Saldo'))
...
currentTime.set(Calendar.MINUTE, 03)
...
WebUI.click( findTestObject('Object Repository/Page_Manajemen Saldo  admin/a_Lihat'))
