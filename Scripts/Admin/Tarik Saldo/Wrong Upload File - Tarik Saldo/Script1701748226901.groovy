...
WebUI.click(findTestObject('Object Repository/Page_Tambah Manajemen Saldo  admin/div_Tarik Saldo'))
...
WebUI.uploadFile(findTestObject('Object Repository/Page_Tambah Manajemen Saldo  admin/input_urlTransfer'), 'C:\\\\Users\\\\Public\\\\Pictures\\\\Katalon_ManualMode.pdf')
...
WebUI.verifyTextPresent("Upload Bukti Transfer harus berupa berkas berjenis: png, jpg, jpeg.", false)
